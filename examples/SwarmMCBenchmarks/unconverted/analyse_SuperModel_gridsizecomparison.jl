...
if true
    ...
    for Temp in Temps, gridsize in [0, 10^4]
        if gridsize == 0
        ...
        data = GetAll(:ETd, plotvars..., restrict=restrict, exclude=exclude, sortby=:ETd, quiet=true, include_prefix=false, include_sortby=false)
